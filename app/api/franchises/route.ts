...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json(await getFranchises({ area: url.searchParams.get("area") || undefined, category: url.searchParams.get("category") || undefined, search: url.searchParams.get("search") || undefined, limit: Number(url.searchParams.get("limit") || 100) }));
  } catch (error) {
