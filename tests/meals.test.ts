...
const meal: Meal = { id: "test", serviceDate: "2026-08-10", day: "Monday", shortDate: "10 Aug", name: "Balanced lunch", description: "Test meal", tags: ["Vegetarian"], protein: 20, calories: 640, price: 49, rating: 4.9, color: "green", emoji: "🍱", nutritionStatus: "provisional" };
